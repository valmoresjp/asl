...
urlpatterns = [
         ...
         path('factura/agregar/<str:tipo>/',views.agregar_factura,name="agregar_factura_mate"),
         path('factura/listar/<str:tipo>/',views.listar_factura,name="listar_factura_mate"),
         path('personal/',views.listar_personal,name="listar_personal_mate"),
         path('personal/agregar',views.agregar_personal,name="agregar_personal_mate"),
         path('factura/contenido/<int:idfactu>/',views.contenido_factura,name="contenido_factura_mate"),
         path('factura/detalle/<int:idfactu>/',views.detalle_factura,name="detalle_factura_mate"),
